...
class Requirement(BaseModel):
    """Represents a functional requirement for the API."""
...
class GenerateRequest(BaseModel):
    """Request to generate an OpenAPI specification."""
...
class GenerateResponse(BaseModel):
    """Response containing generated OpenAPI specification."""
...
class ValidateRequest(BaseModel):
    """Request to validate an OpenAPI specification."""
...
class ArtifactRequest(BaseModel):
    """Request to generate an artifact from OpenAPI specification."""
...
class ArtifactResponse(BaseModel):
    """Response containing generated artifact."""
